...
def send_file():
    ...
    try:
        ...
        chan.sendall(f"FILE|{current_contact}|{filename}##{file_b64}\n".encode('utf-8'))
        ...
        try:
            ...
            while b"\n" in buffer:
                ...
                if header == "KEYSHARE":
                    ...
                    sender = parts[1].strip().lower()
                    secret = parts[2]
                    #debug_log("INCOMING MSG", sender, username, secret)
